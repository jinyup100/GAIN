...
class TrainMaskedMNIST(Dataset):
    def __init__(self, data_dir=r'C:\Users\jin\data', image_size=28, random_seed=0):
...
class TrainBlockMaskedMNIST(TrainMaskedMNIST):
...
class TrainIndepMaskedMNIST(TrainMaskedMNIST):
...
class TestBlockMaskedMNIST(TestMaskedMNIST):
    def __init__(self, block_len=None, *args, **kwargs):
        self.block_len = block_len
        super().__init__(*args, **kwargs)
...
class TestIndepMaskedMNIST(TestMaskedMNIST):
    def __init__(self, obs_prob=.2, obs_prob_high=None, *args, **kwargs):
        self.prob = obs_prob
        self.prob_high = obs_prob_high
        super().__init__(*args, **kwargs)
